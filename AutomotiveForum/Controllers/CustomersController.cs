...
namespace AutomotiveForum.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,StreetAdress,State,Email,ZipCode,DateOfBirth,Date,UserId")] Customers customers)
        {
            ...
            ViewBag.UserId = new SelectList(db.Users, "Id", "UserRole", customers.UserId);
            return View(customers);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,StreetAdress,State,Email,ZipCode,DateOfBirth,Date,UserId")] Customers customers)
        {
            if (ModelState.IsValid)
            {
