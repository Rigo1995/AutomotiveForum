...
namespace AutomotiveForum.Controllers
{
    public class ForumController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CommentId,Timestamp,Comment,UserId")] Forum forum)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CommentId,Timestamp,Comment,UserId")] Forum forum)
        {
            if (ModelState.IsValid)
            {
